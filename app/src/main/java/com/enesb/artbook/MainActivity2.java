...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (info.matches("new")) { // Eger yeni bir sey eklenmeye calisiyorsa
            artNameText.setText("");
    ...
    public void selectImage(View view) {
        // Eger fotograf sece tiklandiginda galeriye erismeye izin vermediyse
    ...
    @Override   // izin cikarsa ne yapacak
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == 2 && resultCode == RESULT_OK && data != null) {
            ...
            try {
                ...
                if (Build.VERSION.SDK_INT >= 28) { // Eger sdk sürümü 28 den kücükse
    ...
    public void save(View view) {
        ...
        // Görseli alip veriye cevirme islemi
        ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
        smallImage.compress(Bitmap.CompressFormat.PNG,50,outputStream); // PNG seklinde kaydet, kalitesi 50 olsun
        ...
        try {
            ...
            sqLiteStatement.execute(); // calistirma
        ...
        // Islem bitince diger aktiviteye gecis yapma
    ...
    public Bitmap makeSmallerImage(Bitmap image, int maximumSize) {
        ...
        return Bitmap.createScaledBitmap(image,width,height,true); // Kücültülmüs bir Bitmap veriyor
    }
